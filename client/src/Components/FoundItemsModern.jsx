  ...
  useEffect(() => {
    ...
    Axios({
      ...
      .then((response) => {
        ...
        paginateItems(foundItems, page, searchQuery);
        setLoading(false);
      })
      .catch((err) => {
      ...
      <div className="relative overflow-hidden" style={{
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          >
            ...
            >
              Browse items people have found. Claim yours if you see it!
            </Typography>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        {loading ? (
          ...
          <div className="text-center py-20">
            <CheckBadgeIcon className="w-24 h-24 mx-auto text-gray-300 mb-4" />
            <Typography variant="h5" color="text.secondary" className="mb-2">
              No found items
            </Typography>
            <Typography variant="body1" color="text.secondary">
              {searchQuery ? 'Try a different search query' : 'No found items have been reported yet'}
            </Typography>
          </div>
        ) : (
          <AnimatePresence>
                    ...
                    <div className="space-y-2 mb-4">
                      {item.location && (
                        <div className="flex items-start gap-2 text-gray-600">
                          <MapPinIcon className="w-5 h-5 mt-0.5 shrink-0 text-green-500" />
                      ...
                      <div className="flex items-start gap-2 text-gray-600">
                        <ClockIcon className="w-5 h-5 mt-0.5 shrink-0 text-green-500" />
...
export default FoundItemsModern;
